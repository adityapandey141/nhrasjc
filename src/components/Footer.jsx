        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-xs text-gray-300">Social Justice Welfare Foundation</p>
              </div>
            </div>
            <p className="text-gray-300 text-sm leading-relaxed mb-4">
              National Human Rights & Anti Corruption Social Justice Welfare Foundation - 
              A registered non-profit organization dedicated to protecting human rights, 
              fighting corruption, and empowering communities.
            </p>
          ...
          <div>
            ...
            <div className="mt-6 p-4 bg-white/10 rounded-lg">
              ...
              <p className="text-xs text-gray-300">NitiAyog: U88900GJ2023NPL145998</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="container-custom py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-gray-400 text-sm">
              © {currentYear} National Human Rights & Anti Corruption Social Justice Welfare
              Foundation. All rights reserved.
            </p>
            <p className="text-gray-400 text-sm flex items-center gap-1">
              Made with <Heart size={14} className="text-red-500 fill-red-500" /> for a better society
            </p>
          </div>
        </div>
      </div>
