...
const teamMembers = [
  {
    ...
    description: 'Visionary leader with 20+ years of experience in social welfare and human rights advocacy.',
  },
  {
    name: 'Mrs. Priya Sharma',
    role: 'Vice Chairperson',
    image: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&q=80',
    description: 'Dedicated activist working for women empowerment and gender equality.',
  },
  {
    name: 'Mr. Amit Patel',
    role: 'Secretary General',
    image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&q=80',
    description: 'Expert in organizational management and community development programs.',
  },
  {
    name: 'Dr. Sunita Verma',
    role: 'Director - Programs',
    image: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=400&q=80',
    description: 'PhD in Social Work with expertise in designing impactful community programs.',
  },
  {
    name: 'Mr. Vikram Singh',
    role: 'Legal Advisor',
    image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&q=80',
    description: 'Senior advocate specializing in human rights law and anti-corruption cases.',
  },
  {
    name: 'Mrs. Anjali Desai',
    role: 'Treasurer',
    image: 'https://images.unsplash.com/photo-1594744803329-e58b31de8bf5?w=400&q=80',
    description: 'Chartered Accountant ensuring transparent and efficient financial management.',
  },
  {
    name: 'Mr. Rahul Mehta',
    role: 'Youth Coordinator',
    image: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=400&q=80',
    description: 'Young leader driving youth engagement and skill development initiatives.',
  },
  {
    name: 'Mrs. Kavita Joshi',
    role: 'Women Wing Head',
    image: 'https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=400&q=80',
    description: 'Passionate advocate for women rights and empowerment programs.',
  },
];
    ...
    <div>
      ...
      <section className="py-20 bg-gradient-to-r from-purple-700 via-red-600 to-orange-500 text-white">
        <div className="container-custom text-center">
          <h1 className="text-4xl md:text-5xl font-heading font-bold mb-4">Core Team</h1>
      ...
      <section className="py-20 bg-gradient-to-r from-purple-700 via-red-600 to-orange-500 text-white">
        <div className="container-custom text-center">
          ...
          <p className="text-purple-100 max-w-2xl mx-auto mb-8">
            Be part of a movement that is changing lives. We welcome volunteers, activists, 
            and professionals who share our vision for a just society.
          </p>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center mb-12">
            <span className="text-orange-500 font-semibold uppercase tracking-wider text-sm">Our Culture</span>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <h3 className="font-heading font-bold text-xl text-gray-800 mb-3">Mission-Driven</h3>
              <p className="text-gray-600">
                Every member is committed to our core mission of protecting rights and fighting corruption.
              </p>
            </div>
            <div className="text-center p-6">
              <div className="text-5xl mb-4">🤝</div>
              <h3 className="font-heading font-bold text-xl text-gray-800 mb-3">Collaborative</h3>
              <p className="text-gray-600">
                We believe in teamwork and collective action to achieve greater impact.
              </p>
            </div>
            <div className="text-center p-6">
              <div className="text-5xl mb-4">💡</div>
              <h3 className="font-heading font-bold text-xl text-gray-800 mb-3">Innovative</h3>
              <p className="text-gray-600">
                We embrace new ideas and approaches to solve complex social challenges.
              </p>
            </div>
          </div>
        </div>
