          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Established with a vision to create a corruption-free and just
                society, the National Human Rights & Anti Corruption Social
                Justice Welfare Foundation (NHRSJWF) has been at the forefront
                of protecting human rights and fighting corruption across India.
              </p>
              <p className="text-gray-600 mb-4">
                Our foundation was born out of the need to address the growing
                concerns of human rights violations and rampant corruption that
                affects the common citizen. We believe that every individual
                deserves to live with dignity, free from exploitation and
                injustice.
              </p>
              <p className="text-gray-600">
                Over the years, we have expanded our reach to multiple states,
                conducting awareness programs, providing legal aid, and
                empowering communities to stand up for their rights. Our
                dedicated team of volunteers and activists work tirelessly to
                ensure that justice reaches every corner of society.
              </p>
            </div>
        ...
        <div className="container-custom">
          <div className="grid md:grid-cols-2 gap-8">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-600">
                    To protect and promote human rights for all citizens
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle
                  ...
                  />
                  <span className="text-gray-600">
                    To fight corruption at all levels of society
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle
                ...
                <li className="flex items-start gap-3">
                  ...
                  />
                  <span className="text-gray-600">
                    To provide legal awareness and support to the
                    underprivileged
                  </span>
                </li>
              </ul>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm">
              ...
              <p className="text-gray-600 mb-4">
                We envision an India where every citizen lives with dignity and
                their fundamental rights are protected. A society free from
                corruption, discrimination, and injustice.
              </p>
              <p className="text-gray-600">
                Our vision extends to creating self-reliant communities that can
                advocate for their rights, where women are empowered, youth are
                skilled, and the marginalized are uplifted. We strive for a
                nation where justice is accessible to all, regardless of social
                or economic status.
              </p>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
              ...
              <blockquote className="text-gray-600 text-lg italic mb-6 border-l-4 border-purple-700 pl-6">
                "Our commitment to social justice is unwavering. Every day, we
                work towards building a society where human rights are
                respected, corruption is eliminated, and every citizen has equal
                opportunities to thrive."
              </blockquote>
              <p className="text-gray-600 mb-4">
                As the Chairman of NHRSJWF, I am proud to lead a team of
                dedicated individuals who share the common goal of creating
                positive change. Our foundation has touched countless lives
                through our various programs and initiatives.
              </p>
              <p className="text-gray-600">
                I invite you to join us in this noble mission. Together, we can
                build a stronger, more just society for future generations.
              </p>
              <div className="mt-6">
        ...
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-purple-100 max-w-2xl mx-auto">
              NHRSJWF is a legally registered non-profit organization with all
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                We believe in equal justice for all, regardless of social,
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                We empower communities with knowledge, skills, and resources to
